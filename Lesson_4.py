...
#
# new_list = [i if my_list[i] > my_list[i - 1] else 'min' for i in my_list ]
#
...
# from random import randint
# my_list_4 = [randint(1, 10) for i in range(5)]
# print(f'Дан случайный список - {my_list_4}')
#
# new_list = [elem for elem in my_list_4 if my_list_4[i] != my_list_4[i + 1]]
# new_list = []
# for el in my_list_4:
#     b = 0
#     for i in my_list_4:
